...
# print first array
echo "Displaying the column arrays:"
echo "${column_0[@]}"
echo "${column_1[@]}"
echo "${column_2[@]}"
...
# for loop to populate new array which is the difference of the 3rd and 2nd column
...
paste -d "," $csv_file column_3.txt > resport.csv